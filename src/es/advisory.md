...
1. **<a id="data">Inteligencia Artificial & Estrategia de Datos</a>**
...
- ¿Necesito algoritmos complejos de Aprendizaje Automático o _Deep Learning_, o no son necesarios?
...
2. **<a id="experiments">Generación & gestión de datos</a>**
...
Si ya tiene un flujo de datos que se utiliza en vuestra institución, también podemos optimizar y mejorar su generación, preprocesamiento y _wrangling_ de datos en general para su uso futuro con modelos estadísticos, de aprendizaje automático o de inteligencia artificial, así como guiaros a través de la formalización de un [Plan de Gestión de Datos](https://datamanagement.hms.harvard.edu/plan-design/data-management-plans) que se adapte a sus necesidades.

<img src="/images/datacloud.webp" style="display: block; margin: 0 auto; width: 40%;">

3. **<a id="statistics">Modelado Estadístico</a>**
...
4. **<a id="computing">Computación Científica & Matemática</a>**
